...
def create_training_options():
    ...
    parser.add_argument("--interval",       type=int,   default=500,        help="number of interval")
...
def main(opt):
    ...
    log.info("=======================================================")
    log.info("         I2P: Planning with Image to Image Translation")
    log.info("=======================================================")
    ...
    train_dataset = I2PDataset(split='train')
    val_dataset = I2PDataset(split='test')
